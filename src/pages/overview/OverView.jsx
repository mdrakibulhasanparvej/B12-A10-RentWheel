      ...
      <div className="container mx-auto px-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 ">
          ...
          <motion.div
            ...
            className="px-6 py-3 border border-gray-200 rounded-2xl text-gray-800 dark:text-white dark:border-gray-100 bg-white dark:bg-gray-800 shadow-sm flex flex-col"
          >
            <div>
